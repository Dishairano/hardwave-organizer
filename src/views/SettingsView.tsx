...
export function SettingsView({ user, onLogout, onCheckUpdates, onBackToHub }: SettingsViewProps) {
      ...
      <div className="p-6 border-b border-bg-hover">
        <div className="flex items-center gap-3 mb-2">
          {onBackToHub && (
            <button
              onClick={onBackToHub}
              className="w-8 h-8 rounded-lg bg-bg-hover hover:bg-bg-secondary flex items-center justify-center text-text-tertiary hover:text-text-primary transition-colors"
              title="Back to Hub"
            >
        ...
        <p className="text-text-secondary">Configure your Hardwave Suite experience</p>
      </div>
