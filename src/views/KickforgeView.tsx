...
interface KickforgeViewProps {
  onBackToHub?: () => void
}

export function KickforgeView({ onBackToHub }: KickforgeViewProps) {
    ...
    <div className="flex-1 flex flex-col overflow-hidden bg-bg-primary">
      ...
      <div className="p-6 border-b border-bg-hover">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-2xl font-bold text-text-primary">Kickforge</h1>
        </div>
